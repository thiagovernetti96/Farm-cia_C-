...
namespace Farmácia_C_.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Data_De_Entrada,Validade,Preco,FornecedorID")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Data_De_Entrada,Validade,Preco,FornecedorID")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
